...
<br><br>
<h3 style="background-color:#0d4353d4;color:#f3ffe1;line-height:58px;font-size:220%;padding-left:200px;">  AN OCEAN HEALTH INDEX FOR THE BALTIC SEA </h3>
</div>
</div>
...
<div class="wrap page-lead-content" style="background-color:#edf3f5b6;padding:10px;font-family:PT Sans;margin-bottom:12px;">
<img align="right" src="images/src-su-logo.png" height="65px">
<img align="left" src="images/original-logo-w-balticsea.png" height="65px"><div style="width: 74%;">
</div>
